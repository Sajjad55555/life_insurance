...
const DentalInsurance: React.FC = () => {
  return (
    <div className=""> {/* Outer wrapper for mobile padding */}
      <div className="w-full flex flex-col flex-wrap max-w-[350px]  md:max-w-[1100px] mx-auto">
        {/* ======================= 주계약 Section ======================= */}
        ...
        <div className='flex flex-col flex-wrap'>
          <div>
            <h2 className="text-2xl school-font md:mb-6">선택특약</h2>
          ...
          <div className="overflow-x-auto text-[14px] nexonReg-font">
        ...
        <div className="flex flex-row gap-2 mb-8">
          <div>
            <strong className="block text-lg school-font mb-2 text-[#150f96]">
              <span>주</span>
              <span className="sr-only">주의사항</span>
            </strong>
          </div>
          <div>
            <ul className="list-decimal list-inside text-[14px]  space-y-2 text-[#767676]">
              <li>
                주계약의 보험료 납입이 면제된 경우 또는 약관 제3조(“영구치”의 정의)에서 정한 “영구치”가 모두 상실된 경우에는 이 특약의 차회 이후 보험료 납입을 면제하여 드립니다.
              </li>
              <li>
                최초계약의 경우 보철치료보장개시일은 계약일로부터 그 날을 포함하여 90일이 지난 날의 다음날로 하며, 부활(효력회복)계약의 경우에는 부활(효력회복)일을 포함하여 90일이 지난 날의 다음날로 합니다.
              </li>
              <li>
        ...
        <div className="flex flex-row gap-2 mb-8">
          ...
          <div className="mb-8">
            <ul className="list-decimal list-inside text-[14px] space-y-2 text-[#767676]">
              ...
              <li>
                피보험자가 보험기간 중 사망하거나 약관 제4조(&quot;영구치&quot;의 정의) 및 약관 제6조(&quot;전치부&quot;, &quot;보철치료&quot;의 정의) 제1항에서 정한 전치부 영구치가 모두 상실되어 약관 제9조(보험금의 지급사유)에서 정하는 보험금 지급사유가 더 이상 발생할 수 없는 경우에는 이 특약은 그때부터 효력이 없으며, 효력이 없어진 당시의 계약자적립액을 계약자에게 지급합니다.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div>
          <div>
            <h2 className="text-2xl font-semibold mb-4 text-[#150f96]">
              선택특약
            </h2>
            <div className="flex flex-col md:flex-row md:justify-between">
              <p className="text-base font-bold mb-6 text-[#150f96]">
